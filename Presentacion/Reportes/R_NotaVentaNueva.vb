...
Public Class R_NotaVentaNueva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_NotaVentaNueva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaVentaNueva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaVentaNueva = New R_NotaVentaNueva()
        rpt.Site = Me.Site
        Return rpt
    End Function
